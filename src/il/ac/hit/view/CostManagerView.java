...
public class CostManagerView implements IView {
    ...
    private AddNewCategoryFrame frameAddNewCategory;
    ...
    public void startAddNewCategory(Account account) {
        frameAddNewCategory = new AddNewCategoryFrame(viewModel, account);
    }
     ...
     */
    @Override
    public void startAddNewCost(Account account, List<Category> categories) {
     ...
     */
    @Override
    public void showReports(List<Cost> costs) {
