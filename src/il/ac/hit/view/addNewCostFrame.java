...
public class addNewCostFrame {
    ...
    private String [] currencyList = { "Dollar - 3.12", "Shekel - 1", "Euro - 3.59", "Sterling - 4.26" };
    ...
    public addNewCostFrame(IViewModel viewModel, Account account, List<Category> categories) {
    ...
    private void initialization()
    {
        ...
        addNewCostFrame.setSize(700, 150);
     ...
     * @return boolean
     */
    public String[] setCategoriesArray(List<Category> categories)
    {
